...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(u => u.Date.Year == 2021 && u.Country == "France" && (u.Home_team == "France") && u.Home_score == u.Away_score);   // Корегуємо запит !!!
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(u => u.Date.Year > 2017 && u.Date.Year < 2021 && u.Away_team == "Germany" && u.Home_score > u.Away_score);   // Корегуємо запит !!!
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(u => u.Tournament == "FIFA World Cup").OrderByDescending(u => u.Date).Take(8);   // Корегуємо запит !!!
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            string res = $"{g.Date.ToString("d")} {g.Home_team} - {g.Away_team}, Score: {g.Home_score} - {g.Away_score}, Country: {g.Country}\n";
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            foreach (var game in selectedGames)
            {
                res += $"{game.MatchYear} {game.Team1} - {game.Team2}, Goals: {game.Goals}\n";
            }
            Console.WriteLine(res);
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            foreach (var game in selectedGames)
            {
                res += $"{game.MatchYear} {game.Game}, Result for team1: {game.Result}\n";
            }
            Console.WriteLine(res);
        ...
        static void Query10(List<FootballGame> games)
        {
            ...
            foreach (var game in selectedGames)
            {
                res += $"{game.Date.ToString("d")} {game.Home_team} - {game.Away_team}, Score: {game.Home_score} - {game.Away_score}, Country: {game.Country}\n";
            }
            Console.WriteLine(res);
